...
const async = asyncState(async () => {
    await new Promise((r) => setTimeout(r, 90));
    return b2() + a1();
}, [a1, b2], { autoStart: true, name: 'asyncNode1' });
const async2 = asyncState(async () => {
    await new Promise((r) => setTimeout(r, 200));
    return b1() + a3();
}, [a1, b2], { autoStart: true, name: 'asyncNode2' });
const c1 = computed(() => {
